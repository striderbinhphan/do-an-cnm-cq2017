...
class SendbackProjectTransaction{
    constructor(projectName, fromAddress, toAddress, amount, sendbackTimestamp, signature) {
    ...
    calculateHash(){
        return SHA256(this.projectName + this.fromAddress+this.toAddress+this.amount+this.sendbackTimestamp).toString();
    }
